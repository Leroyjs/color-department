...
export const ModalShop = observer(({ cost, img, title, discription, isOpen }) => {
      ...
      <ModalShopInner>
        ...
        <InformationColumn>
          ...
          <FormWrapper>
            ...
            <DropDown
              title="Quantity"
              onChange={(option) => setValueQuantity(option)}
              options={QuantityOptions}
              value={valueQuantity}></DropDown>
            <Input mb="lg" title="Name *"></Input>
            <Input title="Contact me by number *"></Input>
